 ...
 */
function gms_theme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['gms_theme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('gms_theme sample setting'),
  '#default_value' => theme_get_setting('gms_theme_example'),
